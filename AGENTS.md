...
## 1. Gestione della Chat Terminal e Routing dei 21 Calcoli
...
- **Riconoscimento delle Intenzioni (Intent Detection)**:
  1. **Saluti & Guida**: Rispondere cordialmente spiegando il ruolo dell'assistente quantistico JOKER 80 e come formulare le richieste per i 21 calcoli.
  2. **Fuori Ambito (Non Industriale)**: Riconoscere richieste estranee alle operazioni di fabbrica e informare l'utente con cortesia indicando i 21 processi disponibili.
